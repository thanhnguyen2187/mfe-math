...
#underline[Answer]
  ...
  $
    i(n) &= 3n^3 + 6n^2 - 4 \
    j(n) &= -3n^3 - 3n^2 + 3n - 1 \
    f(x) &= [x + 4x^2 + x^3 - (n + 1)^3 x^(n + 1) + i(n) x^(n + 2) + j(n) x^(n + 3) + n^3 x^(n + 4)]
  $
  ...
  #table(
    ...
    $f(x)$,    $$,    $1$,   $4$,           $1$,           $$,                   $-(n + 1)^3$,         $i(n)$,              $j(n)$,       $n^3$,
    $f'(x)$,   $1$,   $8$,   $3$,           $$,            $-(n + 1)^4$,         $(n + 2) i(n)$,       $(n + 3) j(n)$,      $(n + 4)n^3$, $$,
    $f''(x)$,  $8$,   $6$,   $$,            $-n(n + 1)^4$, $(n + 1)(n + 2)i(n)$, $(n + 2)(n + 3)j(n)$, $(n + 3)(n + 4)n^3$, $$,           $$,
    $f'''(x)$, $6$,   $$,    $-3n(n +1)^4$, $$,            $$,                   $$,                   $$,                  $$,           $$,
    // $f'(x)$, $$,   $$,   $$,     $$,      $$, $$, $$, $$,            $$,
  )
]
