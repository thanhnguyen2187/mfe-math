...
#underline[Answer]
  ...
  $
    ...
    \
    f'_(24)(x)      &= n^3 x^(n + 4) \
    f^((2))_(24)(x) &= (n + 4) n^3 x^(n + 3) \
    f^((3))_(24)(x) &= (n + 3)(n + 4) n^3 x^(n + 2) \
    f^((4))_(24)(x) &= (n + 2)(n + 3)(n + 4) n^3 x^(n + 1) \
                    &= n(n + 2)(n + 3)(n + 4) n^2 x^(n + 1) \
    \
    g'(x) &= -4 (1 - x)^3 \
    g^((2))(x) &= 12 (1 - x)^2 \
    g^((3))(x) &= -24 (1 - x) \
    ...
    f^((4))(x) &= f^((4))_(1)(x) +
      ...
      f^((4))_(23)(x) +
      f^((4))_(24)(x) \
      &= -3(n - 2)(n - 1)n(n + 1)^4 x^(n - 3) \
      &quad + thick (n - 1)n(n + 1)(n + 2) (3n^3 + 6n^2 - 4) x^(n - 2) \
      &quad + thick n(n + 1)(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) x^(n - 1) \
      &quad + thick n(n + 2)(n + 3)(n + 4) n^2 x^(n + 1) \
