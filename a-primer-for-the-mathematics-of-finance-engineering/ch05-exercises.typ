...
$
  ...
  S(n, 4)
    &= 1 / 5 ((n + 4)^5 - 1 - sum_(j = 0)^3 vec(5, j) S(n, j)) \

    &= 1 / 5 ((n + 4)^5 - 1 - [vec(5, 0) S(n, 0) + vec(5, 1) S(n, 1) \
    &quad + thick vec(5, 2) S(n, 2) + vec(5, 3) S(n, 3)]) \

    &= 1 / 5 ((n + 4)^5 - 1 - [vec(5, 0) n + vec(5, 1) (n(n + 1)) / 2 \
    &quad + thick vec(5, 2) (n(n + 1)(2n + 1)) / 6 + vec(5, 3) ((n(n + 1)) / 2)^2]) \

    &= 1 / 5 ((n + 4)^5 - 1 - [n + 5n(n + 1) / 2 + 10 (n(n + 1)(2n + 1)) / 6 + 10 ((n(n + 1)) / 2)^2]) \

    &= 1 / 5 ((n + 4)^5 - 1 - [n + 5n(n + 1) / 2 + 10 (n(n + 1)(2n + 1)) / 6 + 10 ((n(n + 1)) / 2)^2]) \

    &= 1 / 5 ((n + 4)^5 - (1 + n) - 5n(n + 1) / 2 - 10 (n(n + 1)(2n + 1)) / 6 - 10 ((n(n + 1)) / 2)^2) \

    &= ((n + 4)^5 - (n + 1)) / 5 - n(n + 1) / 2 - n(n + 1)(2n + 1) / 3 - (n(n + 1))^2 / 2 \

    &= ((n + 4)^5 - (n + 1)) / 5 - 3n(n + 1) / 6 - 2n(n + 1)(2n + 1) / 6 - 3(n(n + 1))^2 / 6 \

    &= ((n + 4)^5 - (n + 1)) / 5 - n(n + 1) / 6 (3 + 2(2n + 1) + 3n(n + 1)) \

    &= ((n + 4)^5 - (n + 1)) / 5 - n(n + 1) / 6 (3 + (4n + 2) + (3n^2 + 3n)) \

    &= ((n + 4)^5 - (n + 1)) / 5 - (n(n + 1)(3n^2 + 7n + 5)) / 6 \

    &= (6((n + 4)^5 - (n + 1)) - 5(n(n + 1)(3n^2 + 7n + 5))) / 30 \
$
...
$
  f(x) &= 6((n + 4)^5 - (n + 1)) \
       &= 6((n^5 + 5 n^4 4 + 10 n^3 4^2 + 10 n^2 4^3 + 5 n 4^4 + 4^5) - (n + 1)) \
       &= 6((n^5 + 20 n^4 + 160 n^3 + 640 n^2 + 1280 n + 1024) - (n + 1)) \
       &= 6(n^5 + 20 n^4 + 160 n^3 + 640 n^2 + 1279 n + 1023) \
  g(x) &= 5(n(n + 1)(-3n^2 - n + 1)) \
       &= 5(n^2 + n)(-3n^2 - n + 1) \
$
