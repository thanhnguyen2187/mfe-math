...
#underline[Answer]
  ...
  $
    f^((4))_(21)(1) + f^((4))_(22)(1)
      ...
      &quad + thick ((n^4 + 2n^3) + (6n^3 + 12n^2) + (-4n - 8))] \

      &= (n - 1)n(n + 1) [((-n^4 + 2n^3) + (-3n^3 + 6n^2) + (-3n^2 + 6n) + (-n + 2)) \
      &quad + thick ((3n^4 + 6n^3) + (6n^3 + 12n^2) + (-4n - 8))] \

      &= (n - 1)n(n + 1) [(-1 + 3)n^4 + (2 - 3 + 6 + 6)n^3 + (6 - 3 + 12)n^2 \
      &quad + thick (6 - 1 - 4)n + (2 - 8)] \
  ...
  $
    f^((4))_(23)(1) + f^((4))_(24)(1)
      &= n(n + 1)(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) x^(n - 1) \
      &quad + thick n(n + 1)(n + 2)(n + 3)(n + 4) n^2 x^n \
  ...
  $
    h_1(n) &= (n - 1)(2n^4 + 11n^3 + 15n^2 - n - 6) \
           ...
           &= ((2n^5 - 2n^4) + (11n^4 - 11n^3) + (15n^3 - 15n^2) \
           &quad + thick (-n^2 + n) + (-6n + 6)) \

           &= 2n^5 + (-2 + 11)n^4 + (-11 + 15)n^3 + (-15 - 1)n^2 \
           &quad + thick (1 - 6)n + 6 \

           &= 2n^5 + 9n^4 + 4n^3 - 16n^2 - 5n + 6 \

    h_2(n) &= (n + 2)(n + 3)(-2n^3 + n^2 + 3n - 1) \

           &= (n^2 + 5n + 6)(-2n^3 + n^2 + 3n - 1) \

           &= (-2n^5 + (-10)n^4 + (-12)n^3) + (n^4 + 5n^3 + 6n^2) \
           &quad + thick (3n^3 + 15n^2 + 18n) + ((-1)n^2 + (-5)n + (-6)) \
           
           &= -2n^5 + (-10 + 1)n^4 + (-12 + 5 + 3)n^3 + \
           &quad + thick (6 + 15 - 1)n^2 + (18 - 5)n - 6 \
  ...
  $
    h_1(n) + h_2(n)
      &= (2n^5 + 9n^4 + 4n^3 - 16n^2 - 5n + 6) \
      &quad + thick (-2n^5 - 9n^4 - 4n^3 + 20n^2 + 13n - 6) \

      &= (2 - 2)n^5 + (9 - 9)n^4 + (4 - 4)n^3 \
      &quad + thick (-16 + 20)n^2 + (-5 + 13)n + (6 - 6) \
  ...
  $
    f^(4)(1) &= n(n + 1) thin h_1(n) + n(n + 1) thin h_2(n) \
    f^(4)(1) &= n(n + 1) [h_1(n) + h_2(n)] \
    f^(4)(1) &= n(n + 1) thin 4n(n + 2) \
    f^(4)(1) &= 4n^2 (n + 1)(n + 2) \

    (f^(4)(1)) / (g^(4)(1)) &= (4n^2 (n + 1)(n + 2)) / 24 \
    (f^(4)(1)) / (g^(4)(1)) &= (n^2(n + 1)(n + 2)) / 6 \
  $
