...
#underline[Answer]
  ...
  $
    ...
    \
    f_(21)(x)       &= -(n + 1)^3 x^(n + 1) \
    f'_(21)(x)      &= -3(n + 1)^4 x^n \
    f^((2))_(21)(x) &= -3n(n + 1)^4 x^(n - 1) \
    f^((3))_(21)(x) &= -3(n - 1)n(n + 1)^4 x^(n - 2) \
    f^((4))_(21)(x) &= -3(n - 2)(n - 1)n(n + 1)^4 x^(n - 3) \
                    &= n(n + 1) x^(n - 3) [-3(n - 2)(n - 1)(n + 1)^3]
  $

  $
    f_(22)(x)       &= l(n) x^(n + 2) \
    f'_(22)(x)      &= (n + 2) l(n) x^(n + 1) \
    f^((2))_(22)(x) &= (n + 1)(n + 2) l(n) x^n \
    f^((3))_(22)(x) &= n(n + 1)(n + 2) l(n) x^(n - 1) \
    f^((4))_(22)(x) &= (n - 1)n(n + 1)(n + 2) l(n) x^(n - 2) \
    f^((4))_(22)(x) &= (n - 1)n(n + 1)(n + 2) (3n^3 + 6n^2 - 4) x^(n - 2) \
                    &= n(n + 1) x^(n - 3) [(n - 1)(n + 2)(3n^3 + 6n^2 - 4) x] \
    \
    f_(23)(x)       &= m(n) x^(n + 3) \
    f'_(23)(x)      &= (n + 3) m(n) x^(n + 2) \
    f^((2))_(23)(x) &= (n + 2)(n + 3) m(n) x^(n + 1) \
    f^((3))_(23)(x) &= (n + 1)(n + 2)(n + 3) m(n) x^n \
    f^((4))_(23)(x) &= n(n + 1)(n + 2)(n + 3) m(n) x^(n - 1) \
    f^((4))_(23)(x) &= n(n + 1)(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) x^(n - 1) \
                    &= n(n + 1) x^(n - 3) [(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) x^2] \
    \
    f_(24)(x)       &= n^3 x^(n + 4) \
    ...
    f^((4))_(24)(x) &= (n + 1)(n + 2)(n + 3)(n + 4) n^3 x^n \
                    &= n(n + 1) x^(n - 3)[(n + 2)(n + 3)(n + 4) n^2 x^3] \
    \
    g'(x) &= -4 (1 - x)^3 \
    g^((2))(x) &= 12 (1 - x)^2 \
    g^((3))(x) &= -24 (1 - x) \
  ...
  $
    f^((4))_(21)(1) + f^((4))_(22)(1)
      &= n(n + 1) 1^(n - 3) [-3(n - 2)(n - 1)(n + 1)^3 + (n - 1)(n + 2)(3n^3 +6n^2 - 4) times 1] \
      &= n(n + 1) [-3(n - 2)(n - 1)(n + 1)^3 + (n - 1)(n + 2)(3n^3 + 6n^2 - 4)] \
      &= n(n + 1)(n - 1) [-3(n - 2)(n + 1)^3 + (n + 2)(3n^3 + 6n^2 - 4)] \
      &= n(n + 1)(n - 1) [-3(n - 2)(n^3 + 3n^2 + 3n + 1) + (n + 2)(3n^3 + 6n^2 - 4)] \
      &= n(n + 1)(n - 1) [-3((n^4 - 2n^3) + (3n^3 - 6n^2) + (3n^2 - 6n) + (n - 2)) \
      &quad + thick ((3n^4 + 6n^3) + (6n^3 + 12n^2) - (4n + 8))] \
      &= n(n + 1)(n - 1) [(-3n^4 + 6n^3 - 9n^3 + 18n^2 - 9n^2 + 18n - 3n + 6) \
      &quad + thick (3n^4 + 6n^3 + 6n^3 + 12n^2 - 4n - 8)] \
      &= n(n + 1)(n - 1) [(-3 + 3)n^4 + (6 - 9 + 6 + 6)n^3 + (18 - 9 + 12)n^2 \
      &quad + thick (18 - 3 - 4)n + (6 - 8)] \
      &= n(n + 1)(n - 1) [9n^3 + 21n^2 + 11n - 2] \
  $

  $
    f^((4))_(23)(1) + f^((4))_(24)(1)
      &= n(n + 1) x^(n - 3) [(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) x^2] \
      &quad + thick n(n + 1) x^(n - 3)[(n + 2)(n + 3)(n + 4) n^2 x^3] \
      &= n(n + 1) 1^(n - 3) [(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) 1^2] \
      &quad + thick n(n + 1) 1^(n - 3)[(n + 2)(n + 3)(n + 4) n^2 1^3] \
      &= n(n + 1) [(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1)] \
      &quad + thick n(n + 1) [(n + 2)(n + 3)(n + 4) n^2] \
      &= n(n + 1) [(n + 2)(n + 3) (-3n^3 - 3n^2 + 3n - 1) + (n + 2)(n + 3)(n + 4) n^2] \
