...
#underline[Answer]
  ...
  $
    ...
    &= (1 + 2 - (n + 1)^3 + (n + 2)(2n^2 + 2n - 1) - (n + 3) n^2) / 0 \
    &= (3 - (n^3 + 3n^2 + 3n + 1) + (2n^3 + 6n^2 + 3n - 2) - (n^3 + 3n^2)) / 0 \
    &= 0 / 0 \
  $

  Let $h = x - 1$, so $x = 1 + h$, $lim_(x -> 1) = lim_(h -> 0)$.

  $
    T(n, 2, x)
      &= (x + x^2 - (n + 1)^2 x^(n + 1) + (2 n^2 + 2 n - 1) x^(n + 2) - n^2 x^(n + 3)) / (1 - x)^3 \
      &= ((1 + h) + (1 + h)^2 - (n + 1)^2 (1 + h)^(n + 1) + (2 n^2 + 2 n - 1) (1 + h)^(n + 2) - n^2 (1 + h)^(n + 3)) / h^3 \
  $
]
